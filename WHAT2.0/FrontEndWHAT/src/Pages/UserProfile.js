...
const UserProfile = () => {
    ...
    useEffect(() => {
        ...
        const fetchUserData = async () => {
            try {
                ...
                const workoutResponse = await axios.get(`${process.env.REACT_APP_API_URL}/workoutHistory`, {
                    headers: { Authorization: `Bearer ${token}` },
                });
    ...
    const fetchAllWalkReports = async () => {
        ...
        try {
            const response = await axios.get(`${process.env.REACT_APP_API_URL}/walkreports`, {
                headers: { Authorization: `Bearer ${token}` },
            });
    ...
    const fetchAllRunReports = async () => {
        ...
        try {
            const response = await axios.get(`${process.env.REACT_APP_API_URL}/runreports`, {
                headers: { Authorization: `Bearer ${token}` },
            });
    ...
    const fetchAllWorkoutReports = async () => {
        ...
        try {
            const response = await axios.get(`${process.env.REACT_APP_API_URL}/workoutHistory`, {
                headers: { Authorization: `Bearer ${token}` },
            });
    ...
    const deleteWalkReport = async (reportId) => {
        ...
        try {
            await axios.delete(`${process.env.REACT_APP_API_URL}/walkreports/${reportId}`, {
                headers: { Authorization: `Bearer ${token}` },
            });
    ...
    const deleteRunReport = async (reportId) => {
        ...
        try {
            await axios.delete(`h${process.env.REACT_APP_API_URL}/runreports/${reportId}`, {
                headers: { Authorization: `Bearer ${token}` },
            });
    ...
    const deleteWorkoutReport = async (reportId) => {
        ...
        try {
            await axios.delete(`${process.env.REACT_APP_API_URL}/workoutHistory/${reportId}`, {
                headers: { Authorization: `Bearer ${token}` },
            });
